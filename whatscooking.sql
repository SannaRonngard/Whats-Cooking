...
insert into Recipe (name, prep_time, instructions, measure) values
  ('Guacamole', '10 minuter','2 avokado
1 tomat
...
2 krm salt
0,5 krm svartpeppar
kajennpeppar','Dela avokadon och ta ur kärnorna. Gröp ur fruktköttet. Lägg fruktköttet i en skål och mixa eller mosa sönder med en gaffel eller i mixer.
...
Servera till tacos, nachos eller chips.');
insert into Recipe (name, prep_time, instructions, measure) values(
